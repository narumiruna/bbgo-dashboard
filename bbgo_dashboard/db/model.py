...
class BinanceKline(Base):
    ...
    __table_args__ = (
        Index(
            "idx_kline_binance_unique", "symbol", "interval", "start_time", unique=True
        ),
    ...
    quote_volume = Column(
        DECIMAL(32, 8), nullable=False, server_default=text("'0.00000000'")
    )
...
class FtxKline(Base):
    ...
    num_trades = Column(INTEGER, nullable=False, server_default=text("'0'"))
    quote_volume = Column(
        DECIMAL(32, 4), nullable=False, server_default=text("'0.0000'")
    )
    taker_buy_base_volume = Column(DECIMAL(32, 8), nullable=False)
    taker_buy_quote_volume = Column(
        DECIMAL(32, 4), nullable=False, server_default=text("'0.0000'")
...
class KucoinKline(Base):
    ...
    __table_args__ = (
        Index("klines_end_time_symbol_interval", "end_time", "symbol", "interval"),
        Index(
            "idx_kline_kucoin_unique", "symbol", "interval", "start_time", unique=True
        ),
    )
...
class NavHistoryDetail(Base):
    ...
    net_asset_in_usd = Column(
        DECIMAL(32, 2), nullable=False, server_default=text("'0.00'")
    )
    net_asset_in_btc = Column(
        DECIMAL(32, 20), nullable=False, server_default=text("'0.00000000000000000000'")
    )
    balance = Column(
        DECIMAL(32, 8), nullable=False, server_default=text("'0.00000000'")
    )
...
class Order(Base):
    ...
    executed_quantity = Column(
        DECIMAL(16, 8), nullable=False, server_default=text("'0.00000000'")
    )
